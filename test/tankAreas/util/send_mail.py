...
class SendEmail:
    ...
    global email_host
    global password
    password = "gscjgakmezsvbbcd"
    email_host = "smtp.qq.com"
    send_user = "864131212@qq.com"

    def send_mail(self,user_list,sub,content):
        user = "TsingyunQA" + "<" + send_user + ">"
        ...
        # smtplib.SMTP_SSL(host='864131212@qq.com').connect(host='864131212@qq.com', port=465)
